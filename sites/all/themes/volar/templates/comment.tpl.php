...
$pic = $comment->picture ? theme('image', array('path' => $comment->picture)) : '<i class="comment-avatar fa fa-user"></i>';
?>
<a class="pull-left" href="#"><?php print $pic; ?></a>
<div class="media-body">
    <div class="comment-item-data">
        <div class="comment-author">
            <a href="#"><?php print $comment->name; ?></a>
        </div>
        <?php print format_date($comment->created); ?>
    </div>
    <p>
