(function($) {
    ...
    if (!isMobile) {
        ...
        $('.color-changer a').on("click", function() {
            ...
            $('.sliding-panel #color-styles').remove();
            $('.sliding-panel').append('<link id = "color-styles" rel="stylesheet" type="text/css" href="/sites/all/themes/volar/css/theme/' + color + '.css" property="stylesheet" media = "all">');
        });
